...
export const claimRuns: ClaimRun[] = [
  {
    ...
    progress: 100,
    steps: [
      { label: "Open claim site", thumb: "globe", done: true },
      { label: "Fill contact info", thumb: "contact", done: true },
      { label: "Enter purchase details", thumb: "receipt", done: true },
      { label: "Reach certification page", thumb: "sign", done: true },
    ],
    enteredData: [
  ...
  },
  {
    ...
    steps: [
      { label: "Open claim site", thumb: "globe", done: true },
      { label: "Fill contact info", thumb: "contact", done: true },
      { label: "Enter order number", thumb: "ticket", done: false },
      { label: "Reach certification page", thumb: "sign", done: false },
    ],
    enteredData: [
      { label: "Full name", value: "Alex Rivera" },
      { label: "Email", value: "alex.rivera@gmail.com" },
  ...
  },
  {
    ...
    progress: 0,
    steps: [
      { label: "Open claim site", thumb: "globe", done: false },
      { label: "Fill contact info", thumb: "contact", done: false },
      { label: "Enter filing year", thumb: "calendar", done: false },
      { label: "Reach certification page", thumb: "sign", done: false },
    ],
    enteredData: [],
  },
